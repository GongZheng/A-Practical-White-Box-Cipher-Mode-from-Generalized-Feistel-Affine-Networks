...
\title{A Practical White-Box Cipher Mode from Generalized Feistel Affine Networks}{GFAN: White Box Cipher Mode}
...
\author[1]{Weijie LI}{}
\author[1]{Zheng GONG}{{cis.gong@gmail.com}}
\author[2]{Yamin WEN}{}
%\author[3]{Ddd AUTHOR}{}

%%% Author information for page head. 页眉中的作者信息
\AuthorMark{Li W, Wen Y, Gong Z}

%%% Authors for citation. 首页引用中的作者信息
\AuthorCitation{Li W, Wen Y, Gong Z}
...
\address[1]{School of Computer Science, Guangzhou {\rm 510631}, China}
\address[2]{School of Mathematics and Statistics, Guangdong Univeristy of Economics and Finances, Guangzhou {\rm 510320}, China}
...
%%% Keywords. 关键词
\keywords{White-box cryptography, block cipher, Generalized Feistel Network, Affine transformation}
